  ...
  const renderProductCard = ({ item }: any) => (
    <View style={styles.productCard}>
      ...
      <View style={styles.actionsRow}>
        ...
        <TouchableOpacity style={[styles.actionBtn, styles.removeBtn]} onPress={() => removeProduct(item)}>
...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: 30, paddingTop: 20, paddingBottom: 15 },
  title: { fontSize: 28, fontWeight: '700', color: '#111827' },
  filterScroll: { maxHeight: 50 },
  filterRow: { flexDirection: 'row', paddingHorizontal: 30, paddingVertical: 10, gap: 8 },
  ...
  price: { fontSize: 16, fontWeight: '600', color: '#FF6B35' },
  ...
  actionBtnText: { fontSize: 11, fontWeight: '600', color: '#111827' },
